...
struct st_arg
{
    ...
    char    lnktname[31];           // 远程表名，remotetname参数后加@dblink。
...
void _help()
{
    ...
    printf("lnktname        远程表名，remotetname参数后加@dblink。\n");
