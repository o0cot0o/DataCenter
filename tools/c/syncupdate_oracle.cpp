...
void _help()
{
    ...
    printf("where           同步数据的条件，为空则表示同步全部的记录，填充在delete本地表和select lnktname表之后，注意：1）where中的字段必须同时在本地表和lnktname表中；2）不要用系统时间作为条件。\n");
