...
int main(int argc, char* argv[])
{
    ...
    if(argc != 5)
    {
        ...
        printf("Example:/project/tools1/bin/procctl 120 /project/idc1/bin/obtcodetodb /project/idc/ini/stcode.ini \"127.0.0.1,root,root,mysql,3306\" utf8 /log/idc/obtcodetodb.log\n\n");
    ...
    for(auto vst : vstcode)
    {
        ...
        memcpy(&stcode, &vst, sizeof(struct st_stcode));
