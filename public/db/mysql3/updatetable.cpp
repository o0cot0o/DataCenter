/*
 * 程序名：updatetable.cpp, 此程序演示开发框架操作MYSQL数据库（修改表中记录）。
 * 作者：wzm
*/
...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    for(int ii=0; ii < 5; ii++)
    {
        ...
        stgirls.weight = 48.39 + ii;
        sprintf(stgirls.btime, "2021-10-02 11:25:%02d", ii);
